...
HD_PWD='C:/vivado_tutorial/digita_design_using_vivado/digita_design_using_vivado.runs/design_1_xup_inv_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_xup_inv_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_xup_inv_0_0.tcl
